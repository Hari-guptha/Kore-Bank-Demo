            ...
            <div id='maincontact'>
                ...
                <div style={{ display: "flex", gap: 20 }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column",marginLeft:"50px",width:"600px"}}>
                        <TextField sx={{marginTop:"10%"}} id="outlined-basic" label="Email" placeholder='Enter your Email' variant="outlined" />
                        <TextField sx={{marginTop:"10%"}} id="outlined-basic" label="Message" placeholder='Enter the message' variant="outlined" />
                        <div style={{display:"flex",justifyContent:"center"}}>
